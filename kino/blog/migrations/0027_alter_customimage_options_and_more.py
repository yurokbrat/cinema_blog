...
class Migration(migrations.Migration):
    dependencies = [
        ('blog', '0026_customimage_customrendition_delete_filmdefaultblog_and_more'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='customimage',
            options={'permissions': [('choose_image', 'Can choose image')], 'verbose_name': 'image',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                    related_name='+', to='blog.customimage', verbose_name='Фотография автора'),
        ),
        migrations.AlterField(
            model_name='blogpage',
            name='body',
            field=wagtail.fields.StreamField([('text', wagtail.blocks.RichTextBlock(label='Текст блога')), ('player',
                                                                                                            wagtail.embeds.blocks.EmbedBlock(
                                                                                                                help_text='Вставьте ссылку из Youtube. Например: http://www.youtube.com/watch?v=Cd2ZTG43BJk',
                                                                                                                label='URL-адрес',
                                                                                                                provider_name='YouTube')),
                                              ('image', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(
                                                  label='Заголовок к блоку с изображениями', required=False)), ('image',
